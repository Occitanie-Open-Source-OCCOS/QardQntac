		...
		magicLink({
			sendMagicLink: async ({ email, url }, request) => {
				...
				if (isEmergency) {
					...
					console.log(`Ceci est un lien de connexion d'urgence pour ${email}`);
		...
		i18n({
			translations: {
				fr: {
					...
					CROSS_SITE_NAVIGATION_LOGIN_BLOCKED: "Navigation inter-site détectée, connexion bloquée",
					...
					EMAIL_VERIFICATION_REQUIRED_FOR_INVITATION: "Vérification de l'email requise pour les invitations",
					...
					FAILED_TO_DELETE_ANONYMOUS_USER_SESSIONS: "Échec de la suppression des sessions de l'utilisateur anonyme",
					...
					ID_TOKEN_NOT_SUPPORTED: "Les tokens d'identification ne sont pas pris en charge",
					...
					INVALID_NEW_USER_CALLBACK_URL: "URL de redirection pour les nouveaux utilisateurs invalide",
					...
					ORGANIZATION_SLUG_ALREADY_TAKEN: "Le slug de l'organisation est déjà pris",
