...
function DialogFooter({
	...
	return (
		<div
			...
			className={cn(
				"-mx-6 -mb-6 mt-6 flex flex-col-reverse gap-4 border-t border-border bg-muted p-6 sm:flex-row sm:justify-end",
				className,
			)}
			{...props}
		>
