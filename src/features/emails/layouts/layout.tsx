			...
			>
				...
				<Body className="bg-background font-sans py-12 px-4">
					<Container className="max-w-[600px] mx-auto">
						<Section className="bg-white p-8 md:p-12 border border-border rounded-2xl">{children}</Section>

						<Section className="mt-8 text-center px-4">
							<Text className="text-secondary text-xs font-medium">{messages.copyright}</Text>
						</Section>
					</Container>
				</Body>
			</Tailwind>
