...
interface AuthFormProps {
	...
	onEmergency: (email?: string) => void;
	onMutationStart?: () => void;
}

export function AuthForm({ callbackURL, defaultValue, onSent, onEmergency, onMutationStart }: AuthFormProps) {
	...
	const { mutate: auth, isPending } = useAuth(callbackURL, onSent);
	...
	return (
		<div className="flex flex-col gap-10">
			...
			>
				...
				<div className="pt-2">
					<Button
						...
						variant="default"
						disabled={isPending}
						className="h-14 w-full px-12 text-lg font-bold rounded-2xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
					>
			...
			<div className="flex justify-center pt-2">
				<button
					type="button"
					onClick={() => onEmergency(form.getValues("email"))}
